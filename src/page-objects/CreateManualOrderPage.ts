...
export class CreateManualOrderPage {
  ...
  constructor(page:Page){
    ...
    this.manualOrderIncreaseQuantity = page.getByRole('cell', { name: 'Load Units Lot Expiry Date UPC Qty On Hand Qty Available Qty To Order BST-1 9/24/25 04150010165179 474 474 .cls-1{fill:#26193c;} .cls-1{fill:#26193c;} Add' }).locator('#quantityToOrder-numberPickerPlusIcon')
    this.manualOrderAddQuantity = page.getByRole('cell', { name: 'Load Units Lot Expiry Date UPC Qty On Hand Qty Available Qty To Order BST-1 9/24/25 04150010165179 474 474 .cls-1{fill:#26193c;} .cls-1{fill:#26193c;} Add' }).getByRole('button', { name: 'Add' })
