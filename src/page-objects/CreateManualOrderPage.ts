...
export class CreateManualOrderPage {
  ...
  constructor(page:Page){
    ...
    this.manualOrderSelectMedication = page.getByRole('row', { name: 'Metoprolol Succinate ER 50 CAPSULE SWLG7000 Not a Hazard 474 474 .cls-1{fill:#26193c;} .cls-1{fill:#26193c;} Add' }).locator('#undefined-plus-icon')
    this.manualOrderIncreaseQuantity = page.getByRole('cell', { name: 'Load Units Lot Expiry Date UPC Qty On Hand Qty Available Qty To Order BST-1 9/24/25 04150010165179 474 474 .cls-1{fill:#26193c;} .cls-1{fill:#26193c;} Add Lot1 12/31/24 Swisslog Rossa 2020 316 316 .cls-1{fill:#26193c;} .cls-1{fill:#26193c;} Add' }).getByRole('row', { name: 'BST-1 9/24/25 04150010165179 9 9 .cls-1{fill:#26193c;} .cls-1{fill:#26193c;} Add' }).locator('#quantityToOrder-numberPickerPlusIcon')
    this.manualOrderAddQuantity = page.getByRole('cell', { name: 'Load Units Lot Expiry Date UPC Qty On Hand Qty Available Qty To Order BST-1 9/24/25 04150010165179 474 474 .cls-1{fill:#26193c;} .cls-1{fill:#26193c;} Add Lot1 12/31/24 Swisslog Rossa 2020 316 316 .cls-1{fill:#26193c;} .cls-1{fill:#26193c;} Add' }).getByRole('row', { name: 'BST-1 9/24/25 04150010165179 9 9 .cls-1{fill:#26193c;} .cls-1{fill:#26193c;} Add' }).getByRole('button', { name: 'Add' })
